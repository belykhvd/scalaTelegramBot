...
class QuestionParserShould extends FlatSpec with Matchers {
  "QuestionParser" should "parse question in all positive cases" in {
    QuestionParser.parse(QuestionParser.definition, "(What color do you like ((for now))?)")
      .map(question => {
    ...
    QuestionParser.parse(QuestionParser.definition, "(What color do you like ((for now))?) (open)")
      .map(question => {
        info(question.asText)
        question.question shouldBe "What color do you like (for now)?"
        question.kind shouldBe Open
    ...
    QuestionParser.parse(QuestionParser.definition, "(What color do you like ((for now))?) (choice) (Blue) (Green) (Red)")
      .map(question => {
        info(question.asText)
        question.question shouldBe "What color do you like (for now)?"
    ...
    QuestionParser.parse(QuestionParser.definition, "(What color do you like ((for now))?) (multi) (Blue) (Green) (Red)")
      .map(question => {
        info(question.asText)
        question.question shouldBe "What color do you like (for now)?"
